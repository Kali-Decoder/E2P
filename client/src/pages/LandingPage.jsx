          ...
          <div className=" flex flex-col flex-wrap items-center justify-between py-5 mx-auto md:flex-row max-w-6xl">
            ...
            <div className="inline-flex items-center mx-4 space-x-4 lg:justify-end">
              <nav className="flex flex-wrap justify-center items-center mb-0 text-base  md:border-gray-200">
                <a
                  href="#_"
                  className="mr-4 text-2xl font-bold leading-6 text-gray-400 hover:text-white"
                >
                  Home
                </a>
                <a
              ...
              <div className="w-full md:w-1/2 md:px-3">
                <div className="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                  ...
                  <p className="mx-auto text-base text-white sm:max-w-md lg:text-3xl md:max-w-3xl">
                    The{" "}
                    <span className="font-bold text-blue-700">Eco-GRiD </span>
      ...
      {isTablet && (
        <div className=" items-center w-full ml-5 justify-center mr-5 mt-20 mb-4 lg:flex">
          ...
          <div className="flex flex-col items-start justify-start w-full h-auto lg:w-1/3">
            ...
            <blockquote className="mt-8 text-lg text-white">
              Empowering producers to profit from one-time investments, such as
              solar, through peer-to-peer transactions.
            </blockquote>
          </div>
        </div>
      )}
        ...
        <div className="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
          <nav className="flex flex-wrap justify-center -mx-5 -my-2">
            <div className="px-5 py-2">
              <a
                href="#"
                className="text-medium leading-6 text-gray-500 hover:text-indigo-600"
              >
                About
              </a>
            </div>
